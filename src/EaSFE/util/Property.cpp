...
namespace EaSFE {
    ...
    int Property::getDiscreteClass()
    {
        return m_discreteclass;
    }
    Property* Property::setDiscreteClass(int discreteclass)
    {
        m_discreteclass = discreteclass;
        return m_instance;
    }
    ...
    int Property::getMaxSelectionNum()
    {
        return m_maxselectionnum;
    }
    Property* Property::setMaxSelectionNum(int maxselectionnum)
    {
        m_maxselectionnum = maxselectionnum;
        return m_instance;
    }
    
    std::vector<string> Property::getUnaryOperators()
    {
        return m_unaryoperators;
    }
    Property* Property::setUnaryOperators(const std::vector<string>& unaryoperators)
    {
        m_unaryoperators = unaryoperators;
        return m_instance;
    }
    std::vector<string> Property::getMutilOperators()
    {
        return m_mutiloperators;
    }
    Property* Property::setMutilOperators(const std::vector<string>& mutiloperators)
    {
        m_mutiloperators = mutiloperators;
        return m_instance;
    }
    ...
    int Property::getMaxFCOperator()
    {
        return m_maxfcoperators;
    }
    Property* Property::setMaxFCOperator(int maxfcoperator)
    {
        m_maxfcoperators = maxfcoperator;
        return m_instance;
    }
    ...
    int Property::getMaxImportanceFeatures()
    {
		return m_maximportancefeatures;
	}
    Property* Property::setMaxImportanceFeatures(int maximportancefeatures)
    {
		m_maximportancefeatures = maximportancefeatures;
		return m_instance;
	}
    int Property::getFlod()
    {
		return m_flod;
	}
    Property* Property::setFlod(int flod)
    {
        m_flod = flod;
        return m_instance;
    }
    int Property::getGBMBoostFeatures()
    {
        return m_gbmboostfeatures;
    }
    Property* Property::setGBMBoostFeatures(int gbmboostfeatures)
	{
		m_gbmboostfeatures = gbmboostfeatures;
		return m_instance;
	}
    Property* Property::readProperty(string propertypath)
    {
        ...
        if (j.find("discreteclass") != j.end())
            m_instance->setDiscreteClass(j["discreteclass"]);
        ...
        if (j.find("maxfcoperators") != j.end())
            m_instance->setMaxFCOperator(j["maxfcoperators"]);
        if (j.find("maxselectionnum") != j.end())
            m_instance->setMaxSelectionNum(j["maxselectionnum"]);
        if (j.find("mutiloperators") != j.end())
            m_instance->setMutilOperators(j["mutiloperators"]);
        ...
        if (j.find("unaryoperators") != j.end())
            m_instance->setUnaryOperators(j["unaryoperators"]);
        ...
        if (j.find("maximportancefeatures") != j.end())
            m_instance->setMaxImportanceFeatures(j["maximportancefeatures"]);
        if (j.find("flod") != j.end())
            m_instance->setFlod(j["flod"]);
        if (j.find("gbmboostfeatures") != j.end())
            m_instance->setGBMBoostFeatures(j["gbmboostfeatures"]);
        return m_instance;
    }
    Property::~Property() {  }
